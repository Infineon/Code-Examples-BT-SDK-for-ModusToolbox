...
CY_EXAMPLE_NAME = BLE_HeartRateClient

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE based Heart Rate Client application
...
CY_MAINAPP_SWCOMP_USED = \
  ...
  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/hrc_lib
