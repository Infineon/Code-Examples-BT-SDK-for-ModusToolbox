...
CY_EXAMPLE_NAME = BLE_HeartRateServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE based Heart Rate Server application
...
CY_MAINAPP_SWCOMP_USED =  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/hrs_lib
