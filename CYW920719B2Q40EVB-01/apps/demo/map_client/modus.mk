...
CY_EXAMPLE_NAME = MapClient

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a MAP client application
...
CY_MAINAPP_SWCOMP_USED =   \
  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/map_lib \
  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/obex_lib

CY_APP_SOURCE =   \
  ./map_client.c \
  ./map_client_nvram.c \
  ./map_client_wiced_hci.c \
  ./wiced_bt_cfg.c \
  ./readme.txt
