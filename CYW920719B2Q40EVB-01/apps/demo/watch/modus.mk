...
ifneq ($(filter CYW920819EVB-02 CYW920820EVB-02,$(PLATFORM)),)
MAX_LE_CLIENT_CONN_DEFAULT = 1
else
MAX_LE_CLIENT_CONN_DEFAULT = 3
endif
...
APP_FEATURES += WICED_MAX_LE_CLIENT_CONN,app,integer,$(MAX_LE_CLIENT_CONN_DEFAULT),0,3

SLEEP_SUPPORT ?= $(SLEEP_SUPPORT_DEFAULT)
COEX_SUPPORT ?= $(COEX_SUPPORT_DEFAULT)
WICED_MAX_LE_CLIENT_CONN ?= $(MAX_LE_CLIENT_CONN_DEFAULT)
...
CY_APP_DEFINES +=  \
  ...
  -DWICED_MAX_LE_CLIENT_CONN=$(WICED_MAX_LE_CLIENT_CONN)
