...
CY_EXAMPLE_NAME = BT_PhonebookAccessClient

CY_EXAMPLE_DESCRIPTION = This application demonstrates a Phonebook Access client
...
CY_MAINAPP_SWCOMP_USED =   \
  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/pbap_lib \
