 ...
 ******************************************************/
char   *mesh_dev_name         = "Switch";
#if NUM_ONOFF_CLIENTS > 1
uint8_t mesh_appearance[WICED_BT_MESH_PROPERTY_LEN_DEVICE_APPEARANCE]    = { BIT16_TO_8(APPEARANCE_CONTROL_DEVICE_MULTI_SWITCH) };
#else
uint8_t mesh_appearance[WICED_BT_MESH_PROPERTY_LEN_DEVICE_APPEARANCE]    = { BIT16_TO_8(APPEARANCE_CONTROL_DEVICE_SWITCH) };
#endif
