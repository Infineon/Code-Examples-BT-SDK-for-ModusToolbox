...
wiced_result_t blehid_app_init(void)
{
    ...
    /* gatt registration */
    gatt_status = wiced_bt_gatt_register(blekb_gatts_callback);
...
void application_start( void )
{
    ...
    static hci_rpt_db_t hci_rpt_db[] =
    {
       ...
       {blekb_key_std_rpt,     WICED_HID_REPORT_TYPE_INPUT, STD_KB_REPORT_ID,    KEYRPT_LEN},
       {blekb_bitmap_rpt,      WICED_HID_REPORT_TYPE_INPUT, BITMAPPED_REPORT_ID, KEYRPT_NUM_BYTES_IN_BIT_MAPPED_REPORT},
       {&blekb_func_lock_rpt,  WICED_HID_REPORT_TYPE_INPUT, BITMAPPED_REPORT_ID, 1},
    };
