...
CY_EXAMPLE_NAME = BLE_AlertNotificationServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE based Alert Notification Server application

CY_SHOW_NEW_PROJECT := true

CY_VALID_PLATFORMS = CYW989820EVB-01

PLATFORM = CYW989820EVB-01

CY_APP_DEFINES =  \
  -DWICED_BT_TRACE_ENABLE

ifeq ($(PLATFORM),CYW920706WCDEVAL)
CY_APP_DEFINES += -DHIDD_SUPPORT
endif # PLATFORM
...
ifeq ($(PLATFORM),CYW943012EVB-04)
endif # PLATFORM

CY_MAINAPP_SWCOMP_USED = $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/ans_lib
