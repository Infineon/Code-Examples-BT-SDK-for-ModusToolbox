...
CY_EXAMPLE_NAME = BLE_BatteryClient

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE based Battery Service Client application
...
CY_MAINAPP_SWCOMP_USED = \
  ...
  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/bat_client_lib
