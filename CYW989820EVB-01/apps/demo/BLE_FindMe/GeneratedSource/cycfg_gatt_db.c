...
const uint8_t gatt_database[] =
{
    ...
    PRIMARY_SERVICE_UUID16 (HDLS_IAS, __UUID_SERVICE_IMMEDIATE_ALERT),
        /* Characteristic: Alert Level */
        CHARACTERISTIC_UUID16_WRITABLE (HDLC_IAS_ALERT_LEVEL, HDLC_IAS_ALERT_LEVEL_VALUE, __UUID_CHARACTERISTIC_ALERT_LEVEL, LEGATTDB_CHAR_PROP_WRITE_NO_RESPONSE, LEGATTDB_PERM_WRITE_CMD),
};
...
uint8_t app_gap_device_name[] = {'F', 'i', 'n', 'd', ' ', 'M', 'e', ' ', 'T', 'a', 'r', 'g', 'e', 't', };
uint8_t app_gap_appearance[]  = {0x00u, 0x00u, };
uint8_t app_ias_alert_level[] = {0x00u, };
