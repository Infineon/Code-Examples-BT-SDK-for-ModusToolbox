...
CY_EXAMPLE_NAME = BLE_Beacon

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to configure Google Eddystone and Apple iBeacon advertisements and simultaneously advertise both types.
...
CY_MAINAPP_SWCOMP_USED =  \
  $(CY_WICED_LIB_COMP_BASE)/BT-SDK/common/libraries/beacon_lib \
...
APP_FEATURES += USE_256K_SECTOR_SIZE,app,enum,0,0,1
