...
CY_EXAMPLE_NAME = BLE_Mesh_SwitchSmart

CY_EXAMPLE_DESCRIPTION = This demo application shows a BLE Mesh application for a PRI Motion Sensor combined with a on off button.
