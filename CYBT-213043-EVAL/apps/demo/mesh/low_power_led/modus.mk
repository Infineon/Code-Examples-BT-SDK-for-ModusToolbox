...
CY_EXAMPLE_NAME = BLE_Mesh_LowPowerLed

CY_EXAMPLE_DESCRIPTION = This application demonstrates low power led using the Power OnOff server model.
...
ifneq ($(findstring fw_upgrade_lib,$(CY_MAINAPP_SWCOMP_USED)),)
