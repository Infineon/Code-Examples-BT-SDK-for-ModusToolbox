...
CY_EXAMPLE_NAME = BLE_Mesh_Dimmer

CY_EXAMPLE_DESCRIPTION = This demo application shows a simple BLE Mesh dimmer device implementation, based on the Generic Level Client model.
