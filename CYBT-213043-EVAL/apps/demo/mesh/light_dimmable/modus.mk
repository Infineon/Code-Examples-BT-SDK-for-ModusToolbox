...
CY_EXAMPLE_NAME = BLE_Mesh_LightDimmable

CY_EXAMPLE_DESCRIPTION = This demo application shows a simple BLE Mesh dimmable light device implementation, based on the Light Lightness Server model.
