...
CY_EXAMPLE_NAME = BLE_Mesh_OnOffSwitch

CY_EXAMPLE_DESCRIPTION = This demo application shows a simple BLE Mesh On-Off Switch implementation, based on the Generic OnOff Client model.
