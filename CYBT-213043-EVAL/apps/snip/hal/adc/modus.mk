...
CY_EXAMPLE_NAME = HAL_ADC

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to use HAL ADC drivers to read voltage on the DC Channel(GPIO) or read raw ADC samples and convert it to corresponding voltage.
