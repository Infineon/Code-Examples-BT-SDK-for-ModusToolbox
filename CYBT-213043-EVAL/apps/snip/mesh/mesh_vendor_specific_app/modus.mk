...
CY_EXAMPLE_NAME = BLE_Mesh_VendorSpecificApp

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements a vendor specific server model.
...
CY_APP_SOURCE =  \
  ./mesh_vendor_specific_app.c \
  ./mesh_vendor_specific_app.h \
  ./readme.txt
