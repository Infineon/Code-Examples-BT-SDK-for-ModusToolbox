...
CY_EXAMPLE_NAME = BLE_Mesh_Light_HSL_CTL_Server

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Light HSL and CTL server models, a dimmable light that allows hue and saturation and color temperature adjustments.

CY_SHOW_NEW_PROJECT := true

CY_VALID_PLATFORMS = CYBT-213043-EVAL
...
APP_FEATURES += MESH_DIRECTED_FORWARDING,app,enum,0,0,1
MESH_DIRECTED_FORWARDING ?= 0
ifeq ($(MESH_DIRECTED_FORWARDING),1)
CY_APP_DEFINES += -DMESH_DIRECTED_FORWARDING_SUPPORTED
endif

CY_APP_SOURCE =  \
  ./mesh_light_hsl_ctl_server.c \
  ./readme.txt
