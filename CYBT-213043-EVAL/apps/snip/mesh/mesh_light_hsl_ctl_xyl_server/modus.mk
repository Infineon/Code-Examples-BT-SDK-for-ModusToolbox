...
CY_EXAMPLE_NAME = BLE_Mesh_Light_HSL_CTL_XYL_Server

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Light HSL, CTL, and XYL server models, a dimmable color light that allows hue and saturation and color temperature adjustments.
...
CY_APP_SOURCE =  \
  ./mesh_light_hsl_ctl_xyl_server.c \
  ./readme.txt
