...
CY_EXAMPLE_NAME = BLE_Mesh_Light_LC_Server

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Light LC server model, a Light Control device.
