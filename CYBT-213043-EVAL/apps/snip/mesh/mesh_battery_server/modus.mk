...
CY_EXAMPLE_NAME = BLE_Mesh_BatteryServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Generic Battery Level server model.
