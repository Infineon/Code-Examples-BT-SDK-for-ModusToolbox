...
CY_EXAMPLE_NAME = BLE_Mesh_ProvisionServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Mesh Provisioning Service.
