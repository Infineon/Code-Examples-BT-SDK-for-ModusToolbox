...
CY_EXAMPLE_NAME = BLE_Mesh_PowerOnOffServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Generic Power OnOff server model.
