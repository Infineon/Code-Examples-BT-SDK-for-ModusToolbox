...
CY_EXAMPLE_NAME = BLE_Mesh_Light_XYL_Server

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Light XYL server model, a dimmable color light.
