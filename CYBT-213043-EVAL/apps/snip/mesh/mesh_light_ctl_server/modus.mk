...
CY_EXAMPLE_NAME = BLE_Mesh_Light_CTL_Server

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Light CTL server model, a dimmable light that allows color temperature adjustments.
