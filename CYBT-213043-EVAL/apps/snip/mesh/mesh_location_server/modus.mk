...
CY_EXAMPLE_NAME = BLE_Mesh_LocationServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Generic Location server model, which allows a client to configure the location and then publishes its location.
