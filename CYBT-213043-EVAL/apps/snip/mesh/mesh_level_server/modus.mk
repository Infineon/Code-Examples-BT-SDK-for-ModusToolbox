...
CY_EXAMPLE_NAME = BLE_Mesh_LevelServer

CY_EXAMPLE_DESCRIPTION = This application demonstrates how to create a BLE Mesh device that implements the Generic Level server model.
