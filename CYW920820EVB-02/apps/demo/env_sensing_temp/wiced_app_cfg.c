...
const wiced_bt_cfg_settings_t wiced_app_cfg_settings =
{
    ...
    .ble_scan_cfg =                                                                                  /* BLE scan settings*/
    {
        ...
        .high_duty_scan_duration         = 15,                                                       /* High duty scan duration in seconds (0 for infinite)*/
    ...
    {
        .appearance                     = APPEARANCE_SENSOR_TEMPERATURE,                             /* GATT appearance (see gatt_appearance_e)*/
...
/*  { buf_size, buf_count } */
    ...
    { 1024,     8   },      /* Extra Large Buffer Pool - Used for avdt media packets and miscellaneous (if not needed, set buf_count to 0) */
};
