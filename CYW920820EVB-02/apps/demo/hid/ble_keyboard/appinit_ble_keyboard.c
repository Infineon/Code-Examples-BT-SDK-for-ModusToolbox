...
#else
 #define blekb_management_cback NULL
#endif
...
void application_start( void )
{
    ...
    wiced_ble_hidd_start("kbApp", blehid_app_init, blekb_management_cback, &wiced_bt_hid_cfg_settings, wiced_bt_hid_cfg_buf_pools);
